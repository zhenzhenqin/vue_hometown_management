        ...
        <div class="header-right">
          <el-tooltip content="GitHub 源码" placement="bottom">
            <a href="https://github.com/zhenzhenqin/hometown" target="_blank" class="github-link">
              <svg height="24" viewBox="0 0 16 16" width="24" style="fill: white;">
      ...
      <el-container class="inner-container">
        <el-aside width="220px" class="aside">
          <el-menu router :default-active="$route.path" class="el-menu-vertical-demo">
            ...
            <el-menu-item index="/school"><el-icon>
                <School />
              </el-icon><span>学校展示</span></el-menu-item>
            <el-menu-item index="/admin"><el-icon>
                <User />
            ...
            <el-sub-menu index="/manage1">
              <template #title><el-icon>
                  <Menu />
                </el-icon><span>信息介绍</span></template>
            ...
            <el-sub-menu index="/system">
              <template #title><el-icon>
                  <Setting />
                </el-icon><span>系统管理</span></template>
              ...
              <el-menu-item index="/log"><el-icon>
                  <Notebook />
                </el-icon>日志管理</el-menu-item>
              <el-menu-item index="/devlog"><el-icon>
                  <Cpu />
                </el-icon>系统进化</el-menu-item>
            </el-sub-menu>

            <el-sub-menu index="/report">
              <template #title><el-icon>
                  <PieChart />
                </el-icon><span>数据中心</span></template>
